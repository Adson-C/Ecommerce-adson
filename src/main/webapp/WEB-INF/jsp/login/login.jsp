...
<html lang="pt-br">
    ...
    <body id="page-top">
        ...
        <header class="masthead" id="login">
            <div class="container">
                <div class="masthead-subheading">Bem Vindo ao Adson-Commerce!</div>
                    ...
                    <div class="row justify-content-md-center mb-5 text-center">
                        <div class="col-md-12 align-self-center text-center">
                            <div class="form-group input-login mx-auto">
                                <input class="form-control" name="email" value="${email }" id="email" type="email" placeholder="Email *" required="required" data-validation-required-message="Please enter your email address." />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group mb-md-0 input-login mx-auto">
                                <input class="form-control" name="senha" value="${senha }" id="phone" type="password" minlength="6" maxlength="12" placeholder="Senha *" required="required" data-validation-required-message="Insira sua senha." />
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
        ...
        <section class="page-section" id="beneficios">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Aqui na Adson-Commerce você encontra os melhores preços!</h3>
                </div>
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Aqui você encontra e realiza sua compra de maneira prática e rapida! </p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Compra segura e parceiros confiaveis. Caso não receba o produto o reembolso imediato!</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-left">Copyright Â© Adson-Commerce 2022</div>
